...
- [ ] **Kokoro-82M optional high-quality engine.** Offer Kokoro-82M (~80 MB, Apache-2.0) as a selectable high-quality mode alongside the default Piper voices. Richer prosody for users who prefer quality over speed, without forcing the heavier model on low-end hardware.
